...
```{r img-dial, echo=FALSE, fig.align='center', fig.cap="watch dial inspection", out.width="100%"}
...
```{r fig-pareto1, fig.align='center', fig.cap = 'pareto chart example'}
...
```{r fig-pareto2, fig.align='center', fig.cap = 'pareto chart example'}
...
```{r img-dental, echo=FALSE, fig.align='center', fig.cap="dental impression measurement", out.width="100%"}
...
```{r fig-fishbone, fig-ishikawa, fig.align='center', fig.cap = 'ishikawa diagram example'}
cause.and.effect(
...
```{r img-perfume, echo=FALSE, fig.align='center', fig.cap="Perfume destillation line", out.width="100%"}
...
```{r fig-perfumetileplot, fig.align='center', fig.cap = 'tileplot example'}
perfume_long %>%
...
```{r fig-network1, fig.width = 7, fig.height = 6, warning = FALSE, fig.cap = 'raw network plot example'}
perfum_tbl_graph %>% 
...
```{r fig-network2, warning = FALSE, fig.cap="network plot example"}
