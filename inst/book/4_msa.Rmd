...
```{r tbl-tabletskim, eval=FALSE, include=FALSE}
...
```{r fig-tabletPlot1, out.width='95%', fig.cap="example of gage r&R components of variation plot"}
...
```{r fig-tabletPlot5, out.width='95%', fig.cap="example of gage r&R run chart"}
...
```{r fig-tabletPlot2, out.width='95%', fig.cap="example of gage r&R main effects plot"}
...
```{r fig-tabletPlot4, out.width='95%', fig.cap="example of gage r&R interaction plot"}
