...
pet_effects %>%
  ...
  labs(
    ...
    y = "Factor / Level",
    x = "Tensile strenght variation"
  )
```

The plot is complementary to the previous analysis and helps us quickly grasp the the factor A (bi-axial orientation in production has a stronger effect 
