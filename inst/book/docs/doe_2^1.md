...
In a factorial design of experiements we calculate the total number of trials with the expression $a^k$ where a is the number of levels, k the number of factors. A trial represents the number of unique combinations of the factors. To obtain the final number of test runs we have to multiply the number of trials by the number of replicates per trial.
...
<img src="doe_2^1_files/figure-html/unnamed-chunk-6-1.png" width="80%" />
...
<img src="doe_2^1_files/figure-html/unnamed-chunk-9-1.png" width="80%" />
...
<img src="doe_2^1_files/figure-html/unnamed-chunk-10-1.png" width="80%" />
...
<img src="doe_2^1_files/figure-html/unnamed-chunk-11-1.png" width="80%" />
